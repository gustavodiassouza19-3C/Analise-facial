...
export default function CaptureLateralRight() {
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-100 flex items-center justify-center p-4">
      <Card className="max-w-md w-full space-y-6">
        <h1 className="text-2xl font-bold text-[#cca43b] text-center">
          Captura Lateral Direita
        </h1>
        <p className="text-center text-zinc-200">
          Vire o rosto para a direita e tire a foto.
        </p>
        ...
        <div className="flex justify-center space-x-4">
          ...
          <Button onClick={() => alert('Avançar para lateral esquerda')}>
            Avançar
          </Button>
        </div>
      </Card>
